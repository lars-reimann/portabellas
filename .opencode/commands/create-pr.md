...
3. **Draft the PR**: Write a title and body based on the commits and changes. The title should follow the same style as the commit messages (conventional commits). For the body format, load the `gh-cli` OpenCode skill and use the pull request template.
