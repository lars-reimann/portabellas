...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(DataType.List(DataType.UInt64()), False, id="List"),
    ],
)
def test_should_return_whether_type_represents_unsigned_ints(type_: DataType, expected: bool) -> None:
