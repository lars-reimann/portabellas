...
def test_should_get_struct_field(
    ...
    assert_cell_operation_works(value, lambda cell: cell.struct[field_name], expected, type_if_none=type_if_none)
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            DataTypes.Struct(fields={"name": DataTypes.String(), "age": DataTypes.Int64()}),
            lambda cell: cell.struct["name"],
            DataTypes.String(),
            id="get_string_field",
        ),
        pytest.param(
            DataTypes.Struct(fields={"name": DataTypes.String(), "age": DataTypes.Int64()}),
            lambda cell: cell.struct["age"],
            DataTypes.Int64(),
            id="get_int_field",
        ),
        pytest.param(
            ...
            lambda cell: cell.struct["nested"],
