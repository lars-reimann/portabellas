...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("b", 2, "a", "ba", id="non-empty (shorter length)"),
...
def test_should_raise_if_length_is_out_of_bounds() -> None:
    ...
    with pytest.raises(OutOfBoundsError):
        column.map(lambda cell: cell.str.pad_end(-1))
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(DataTypes.String(), lambda cell: cell.str.pad_end(1), DataTypes.String(), id="string"),
    ],
)
