...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(DataTypes.Int32(), lambda cell: math.floor(cell), DataTypes.Int32(), id="int"),
        pytest.param(DataTypes.Float64(), lambda cell: math.floor(cell), DataTypes.Float64(), id="float"),
    ],
)
