...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(DataTypes.Boolean(), lambda cell: cell ^ True, DataTypes.Boolean(), id="__xor__"),
        pytest.param(DataTypes.Boolean(), lambda cell: True ^ cell, DataTypes.Boolean(), id="__rxor__"),
        pytest.param(DataTypes.Boolean(), lambda cell: cell.xor(True), DataTypes.Boolean(), id="xor"),  # noqa: FBT003
    ],
)
