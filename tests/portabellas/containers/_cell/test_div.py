...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(DataTypes.Int32(), DataTypes.Int32(), lambda a, b: a / b, DataTypes.Float64(), id="int_same"),
        pytest.param(DataTypes.Int8(), DataTypes.Int16(), lambda a, b: a / b, DataTypes.Float64(), id="int_promotion"),
        pytest.param(DataTypes.UInt64(), DataTypes.Int64(), lambda a, b: a / b, DataTypes.Float64(), id="uint64_int64"),
        pytest.param(
            DataTypes.Float32(), DataTypes.Float64(), lambda a, b: a / b, DataTypes.Float64(), id="float_promotion"
        ),
        pytest.param(
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(DataTypes.Int8(), lambda cell: cell / 3, DataTypes.Float64(), id="int8_div_int"),
        pytest.param(DataTypes.Int32(), lambda cell: cell / 3, DataTypes.Float64(), id="int32_div_int"),
        pytest.param(DataTypes.Int64(), lambda cell: cell / 3, DataTypes.Float64(), id="int64_div_int"),
        pytest.param(DataTypes.Int32(), lambda cell: cell / 3.14, DataTypes.Float64(), id="int32_div_float"),
        pytest.param(
            DataTypes.Duration(time_unit="us"),
            lambda cell: cell / 3,
            DataTypes.Duration(time_unit="us"),
