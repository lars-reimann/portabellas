...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(DataTypes.Boolean(), lambda cell: cell | True, DataTypes.Boolean(), id="__or__"),
        pytest.param(DataTypes.Boolean(), lambda cell: True | cell, DataTypes.Boolean(), id="__ror__"),
        pytest.param(DataTypes.Boolean(), lambda cell: cell.or_(True), DataTypes.Boolean(), id="or_"),  # noqa: FBT003
    ],
)
