...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(lambda cell: cell | True, DataTypes.Boolean(), id="__or__"),
        pytest.param(lambda cell: True | cell, DataTypes.Boolean(), id="__ror__"),
        pytest.param(lambda cell: cell.or_(True), DataTypes.Boolean(), id="or_"),  # noqa: FBT003
    ],
)
