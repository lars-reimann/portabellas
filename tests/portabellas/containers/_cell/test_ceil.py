...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(DataTypes.Int32(), lambda cell: math.ceil(cell), DataTypes.Int32(), id="int"),
        pytest.param(DataTypes.Float64(), lambda cell: math.ceil(cell), DataTypes.Float64(), id="float"),
    ],
)
