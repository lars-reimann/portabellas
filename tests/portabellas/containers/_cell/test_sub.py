...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(3, 1.5, 1.5, id="int - float"),
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(DataTypes.Int8(), lambda cell: cell - 3, DataTypes.Int8(), id="int8_minus_int"),
        pytest.param(DataTypes.Int32(), lambda cell: cell - 3, DataTypes.Int32(), id="int32_minus_int"),
        pytest.param(DataTypes.Int64(), lambda cell: cell - 3, DataTypes.Int64(), id="int64_minus_int"),
        pytest.param(DataTypes.UInt64(), lambda cell: cell - 3, DataTypes.UInt64(), id="uint64_minus_int"),
        pytest.param(DataTypes.Int32(), lambda cell: cell - 3.14, DataTypes.Float64(), id="int32_minus_float"),
    ],
)
