...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(DataTypes.Int32(), lambda cell: cell == 1, DataTypes.Boolean(), id="__eq__"),
        pytest.param(DataTypes.Int32(), lambda cell: cell.eq(1), DataTypes.Boolean(), id="eq"),
        pytest.param(
            DataTypes.Int32(),
            lambda cell: cell.eq(1, propagate_nulls=True),
            DataTypes.Boolean(),
            id="eq-propagate-nulls",
        ),
    ],
)
