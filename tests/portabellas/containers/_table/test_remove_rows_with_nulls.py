...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            id="nulls (all columns selected)",
        ),
        pytest.param(
            lambda: Table({"col1": [1, 2, None], "col2": [1, None, 3], "col3": [None, 2, 3]}),
            ["col1", "col2"],
            Table({"col1": [1], "col2": [1], "col3": [None]}),
            id="nulls (several columns selected)",
        ),
        pytest.param(
            lambda: Table({"col1": [1, 2, None], "col2": [1, None, 3], "col3": [None, 2, 3]}),
            "col1",
            Table({"col1": [1, 2], "col2": [1, None], "col3": [None, 2]}),
            id="nulls (one column selected)",
        ),
        pytest.param(
            lambda: Table({"col1": [1, 2, None], "col2": [1, None, 3], "col3": [None, 2, 3]}),
            [],
            Table({"col1": [1, 2, None], "col2": [1, None, 3], "col3": [None, 2, 3]}),
            id="nulls (no columns selected)",
        ),
    ],
)
class TestHappyPath:
    def test_should_remove_rows_with_nulls(
        self,
        table_factory: Callable[[], Table],
        column_names: str | list[str] | None,
        expected: Table,
    ) -> None:
        actual = table_factory().remove_rows_with_nulls(selector=column_names)
    ...
    def test_should_not_mutate_receiver(
        ...
        original.remove_rows_with_nulls(selector=column_names)
