...
class DatetimeOperations(ABC):
    ...
    def century(self) -> Cell[int | None]:
        ...
        >>> column1.map(lambda cell: cell.dt.century())
        +------+
        |    a |
        |  --- |
        |  i32 |
        ...
        >>> column2.map(lambda cell: cell.dt.century())
        +------+
        |    a |
        |  --- |
        |  i32 |
    ...
    def date(self) -> Cell[python_date | None]:
        ...
        >>> column.map(lambda cell: cell.dt.date())
        +------------+
        | a          |
        | ---        |
        | date       |
    ...
    def day(self) -> Cell[int | None]:
        ...
        >>> column1.map(lambda cell: cell.dt.day())
        +------+
        |    a |
        |  --- |
        |   i8 |
        ...
        >>> column2.map(lambda cell: cell.dt.day())
        +------+
        |    a |
        |  --- |
        |   i8 |
    ...
    def day_of_week(self) -> Cell[int | None]:
        ...
        >>> column1.map(lambda cell: cell.dt.day_of_week())
        +------+
        |    a |
        |  --- |
        |   i8 |
        ...
        >>> column2.map(lambda cell: cell.dt.day_of_week())
        +------+
        |    a |
        |  --- |
        |   i8 |
    ...
    def day_of_year(self) -> Cell[int | None]:
        ...
        >>> column1.map(lambda cell: cell.dt.day_of_year())
        +------+
        |    a |
        |  --- |
        |  i16 |
        ...
        >>> column2.map(lambda cell: cell.dt.day_of_year())
        +------+
        |    a |
        |  --- |
        |  i16 |
    ...
    def hour(self) -> Cell[int | None]:
        ...
        >>> column1.map(lambda cell: cell.dt.hour())
        +------+
        |    a |
        |  --- |
        |   i8 |
        ...
        >>> column2.map(lambda cell: cell.dt.hour())
        +------+
        |    a |
        |  --- |
        |   i8 |
    ...
    def microsecond(self) -> Cell[int | None]:
        ...
        >>> column1.map(lambda cell: cell.dt.microsecond())
        +------+
        |    a |
        |  --- |
        |  i32 |
        ...
        >>> column2.map(lambda cell: cell.dt.microsecond())
        +------+
        |    a |
        |  --- |
        |  i32 |
    ...
    def millennium(self) -> Cell[int | None]:
        ...
        >>> from portabellas import Column
        >>> column1 = Column("a", [datetime(1999, 12, 31), datetime(2000, 1, 1), datetime(2001, 1, 1), None])
        >>> column1.map(lambda cell: cell.dt.millennium())
        +------+
        |    a |
        |  --- |
        |  i32 |
        ...
        >>> column2 = Column("a", [date(1999, 12, 31), date(2000, 1, 1), date(2001, 1, 1), None])
        >>> column2.map(lambda cell: cell.dt.millennium())
        +------+
        |    a |
        |  --- |
        |  i32 |
    ...
    def millisecond(self) -> Cell[int | None]:
        ...
        >>> column1.map(lambda cell: cell.dt.millisecond())
        +------+
        |    a |
        |  --- |
        |  i32 |
        ...
        >>> column2.map(lambda cell: cell.dt.millisecond())
        +------+
        |    a |
        |  --- |
        |  i32 |
    ...
    def minute(self) -> Cell[int | None]:
        ...
        >>> column1.map(lambda cell: cell.dt.minute())
        +------+
        |    a |
        |  --- |
        |   i8 |
        ...
        >>> column2.map(lambda cell: cell.dt.minute())
        +------+
        |    a |
        |  --- |
        |   i8 |
    ...
    def month(self) -> Cell[int | None]:
        ...
        >>> from portabellas import Column
        >>> column1 = Column("a", [datetime(1999, 12, 31), datetime(2000, 1, 1), None])
        >>> column1.map(lambda cell: cell.dt.month())
        +------+
        |    a |
        |  --- |
        |   i8 |
        ...
        >>> column2 = Column("a", [date(1999, 12, 31), date(2000, 1, 1), None])
        >>> column2.map(lambda cell: cell.dt.month())
        +------+
        |    a |
        |  --- |
        |   i8 |
    ...
    def quarter(self) -> Cell[int | None]:
        ...
        >>> column1.map(lambda cell: cell.dt.quarter())
        +------+
        |    a |
        |  --- |
        |   i8 |
        ...
        >>> column2.map(lambda cell: cell.dt.quarter())
        +------+
        |    a |
        |  --- |
        |   i8 |
    ...
    def second(self) -> Cell[int | None]:
        ...
        >>> column1.map(lambda cell: cell.dt.second())
        +------+
        |    a |
        |  --- |
        |   i8 |
        ...
        >>> column2.map(lambda cell: cell.dt.second())
        +------+
        |    a |
        |  --- |
        |   i8 |
    ...
    def time(self) -> Cell[python_time | None]:
        ...
        >>> from portabellas import Column
        >>> column = Column("a", [datetime(1999, 12, 31), datetime(2000, 1, 1, 12, 30, 0), None])
        >>> column.map(lambda cell: cell.dt.time())
        +----------+
        | a        |
        | ---      |
        | time     |
    ...
    def week(self) -> Cell[int | None]:
        ...
        >>> column1.map(lambda cell: cell.dt.week())
        +------+
        |    a |
        |  --- |
        |   i8 |
        ...
        >>> column2.map(lambda cell: cell.dt.week())
        +------+
        |    a |
        |  --- |
        |   i8 |
    ...
    def year(self) -> Cell[int | None]:
        ...
        >>> from portabellas import Column
        >>> column1 = Column("a", [datetime(1999, 12, 31), datetime(2000, 1, 1), None])
        >>> column1.map(lambda cell: cell.dt.year())
        +------+
        |    a |
        |  --- |
        |  i32 |
        ...
        >>> column2 = Column("a", [date(1999, 12, 31), date(2000, 1, 1), None])
        >>> column2.map(lambda cell: cell.dt.year())
        +------+
        |    a |
        |  --- |
        |  i32 |
    ...
    def is_in_leap_year(self) -> Cell[bool | None]:
        ...
        >>> column1.map(lambda cell: cell.dt.is_in_leap_year())
        +-------+
        | a     |
        | ---   |
        | bool  |
        ...
        >>> column2.map(lambda cell: cell.dt.is_in_leap_year())
        +-------+
        | a     |
        | ---   |
        | bool  |
    ...
    def replace(
        ...
        *,
        ...
        >>> column1.map(lambda cell: cell.dt.replace(month=2, day=2, hour=2))
        +---------------------+
        | a                   |
        | ---                 |
        | datetime[μs]        |
        ...
        >>> column2.map(lambda cell: cell.dt.replace(month=2, day=2, hour=2))
        +------------+
        | a          |
        | ---        |
        | date       |
    ...
    def to_string(self, *, format: str = "iso") -> Cell[str | None]:  # noqa: A002
        ...
        >>> column1.map(lambda cell: cell.dt.to_string())
        +----------------------------+
        | a                          |
        | ---                        |
        | str                        |
        ...
        >>> column2 = Column("a", [date(1999, 12, 31), date(2000, 1, 1), None])
        >>> column2.map(lambda cell: cell.dt.to_string())
        +------------+
        | a          |
        | ---        |
        | str        |
    ...
    def unix_timestamp(self, *, unit: Literal["s", "ms", "us"] = "s") -> Cell[int | None]:
        ...
        >>> column.map(lambda cell: cell.dt.unix_timestamp())
        +-------+
        |     a |
        |   --- |
        |   i64 |
        ...
        >>> column.map(lambda cell: cell.dt.unix_timestamp(unit="ms"))
        +----------+
        |        a |
        |      --- |
        |      i64 |
