...
class DurationOperations(ABC):
    ...
    >>> column.map(lambda cell: cell.dur.abs())
    +--------------+
    | a            |
    | ---          |
    | duration[μs] |
    ...
    def full_weeks(self) -> Cell[int | None]:
        ...
        >>> column.map(lambda cell: cell.dur.full_weeks())
        +------+
        |    a |
        |  --- |
        |  i64 |
    ...
    def full_days(self) -> Cell[int | None]:
        ...
        >>> column.map(lambda cell: cell.dur.full_days())
        +------+
        |    a |
        |  --- |
        |  i64 |
    ...
    def full_minutes(self) -> Cell[int | None]:
        ...
        >>> column.map(lambda cell: cell.dur.full_minutes())
        +------+
        |    a |
        |  --- |
        |  i64 |
    ...
    def full_seconds(self) -> Cell[int | None]:
        ...
        >>> column.map(lambda cell: cell.dur.full_seconds())
        +------+
        |    a |
        |  --- |
        |  i64 |
    ...
    def full_milliseconds(self) -> Cell[int | None]:
        ...
        >>> column.map(lambda cell: cell.dur.full_milliseconds())
        +------+
        |    a |
        |  --- |
        |  i64 |
    ...
    def full_microseconds(self) -> Cell[int | None]:
        ...
        >>> from portabellas import Column
        >>> column = Column("a", [timedelta(microseconds=1001), timedelta(microseconds=999), None])
        >>> column.map(lambda cell: cell.dur.full_microseconds())
        +------+
        |    a |
        |  --- |
        |  i64 |
