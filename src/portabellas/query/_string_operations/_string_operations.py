...
class StringOperations(ABC):
    ...
    >>> column.map(lambda cell: cell.str.to_uppercase())
    +-----+
    | a   |
    | --- |
    | str |
    ...
    def contains(self, substring: ConvertibleToStringCell) -> Cell[bool | None]:
        ...
        >>> column.map(lambda cell: cell.str.contains("b"))
        +-------+
        | a     |
        | ---   |
        | bool  |
    ...
    def ends_with(self, suffix: ConvertibleToStringCell) -> Cell[bool | None]:
        ...
        >>> column.map(lambda cell: cell.str.ends_with("b"))
        +-------+
        | a     |
        | ---   |
        | bool  |
    ...
    def index_of(self, substring: ConvertibleToStringCell) -> Cell[int | None]:
        ...
        >>> from portabellas import Column
        >>> column = Column("a", ["ab", "cd", None])
        >>> column.map(lambda cell: cell.str.index_of("b"))
        +------+
        |    a |
        |  --- |
        |  u32 |
    ...
    def pad_end(self, length: int, *, character: str = " ") -> Cell[str | None]:
        ...
        >>> column.map(lambda cell: cell.str.pad_end(3))
        +------+
        | a    |
        | ---  |
        | str  |
        ...
        >>> column.map(lambda cell: cell.str.pad_end(3, character="~"))
        +------+
        | a    |
        | ---  |
        | str  |
    ...
    def pad_start(self, length: int, *, character: str = " ") -> Cell[str | None]:
        ...
        >>> from portabellas import Column
        >>> column = Column("a", ["ab", "bcde", None])
        >>> column.map(lambda cell: cell.str.pad_start(3))
        +------+
        | a    |
        | ---  |
        | str  |
        ...
        >>> column.map(lambda cell: cell.str.pad_start(3, character="~"))
        +------+
        | a    |
        | ---  |
        | str  |
    ...
    def remove_prefix(self, prefix: ConvertibleToStringCell) -> Cell[str | None]:
        ...
        >>> from portabellas import Column
        >>> column = Column("a", ["ab", "bc", None])
        >>> column.map(lambda cell: cell.str.remove_prefix("a"))
        +------+
        | a    |
        | ---  |
        | str  |
    ...
    def remove_suffix(self, suffix: ConvertibleToStringCell) -> Cell[str | None]:
        ...
        >>> from portabellas import Column
        >>> column = Column("a", ["ab", "bc", None])
        >>> column.map(lambda cell: cell.str.remove_suffix("b"))
        +------+
        | a    |
        | ---  |
        | str  |
    ...
    def repeat(self, count: ConvertibleToIntCell) -> Cell[str | None]:
        ...
        >>> from portabellas import Column
        >>> column = Column("a", ["ab", "bc", None])
        >>> column.map(lambda cell: cell.str.repeat(2))
        +------+
        | a    |
        | ---  |
        | str  |
    ...
    def replace_all(self, old: ConvertibleToStringCell, new: ConvertibleToStringCell) -> Cell[str | None]:
        ...
        >>> from portabellas import Column
        >>> column = Column("a", ["ab", "bc", None])
        >>> column.map(lambda cell: cell.str.replace_all("b", "z"))
        +------+
        | a    |
        | ---  |
        | str  |
    ...
    def reverse(self) -> Cell[str | None]:
        ...
        >>> from portabellas import Column
        >>> column = Column("a", ["ab", "bc", None])
        >>> column.map(lambda cell: cell.str.reverse())
        +------+
        | a    |
        | ---  |
        | str  |
    ...
    def slice(
        ...
        *,
        ...
        length:
            The length of the slice. If None, the slice contains all characters starting from `start`. Must be greater
            than or equal to 0.
        ...
        >>> column.map(lambda cell: cell.str.slice(start=1))
        +------+
        | a    |
        | ---  |
        | str  |
        ...
        >>> column.map(lambda cell: cell.str.slice(start=1, length=1))
        +------+
        | a    |
        | ---  |
        | str  |
    ...
    def starts_with(self, prefix: ConvertibleToStringCell) -> Cell[bool | None]:
        ...
        >>> from portabellas import Column
        >>> column = Column("a", ["ab", "bc", None])
        >>> column.map(lambda cell: cell.str.starts_with("a"))
        +-------+
        | a     |
        | ---   |
        | bool  |
    ...
    def strip(self, *, characters: ConvertibleToStringCell = None) -> Cell[str | None]:
        ...
        >>> from portabellas import Column
        >>> column = Column("a", ["  ab  ", "~ bc ~", None])
        >>> column.map(lambda cell: cell.str.strip())
        +--------+
        | a      |
        | ---    |
        | str    |
        ...
        >>> column.map(lambda cell: cell.str.strip(characters=" ~"))
        +------+
        | a    |
        | ---  |
        | str  |
    ...
    def strip_end(self, *, characters: ConvertibleToStringCell = None) -> Cell[str | None]:
        ...
        >>> from portabellas import Column
        >>> column = Column("a", ["  ab  ", "~ bc ~", None])
        >>> column.map(lambda cell: cell.str.strip_end())
        +--------+
        | a      |
        | ---    |
        | str    |
        ...
        >>> column.map(lambda cell: cell.str.strip_end(characters=" ~"))
        +------+
        | a    |
        | ---  |
        | str  |
    ...
    def strip_start(self, *, characters: ConvertibleToStringCell = None) -> Cell[str | None]:
        ...
        >>> from portabellas import Column
        >>> column = Column("a", ["  ab  ", "~ bc ~", None])
        >>> column.map(lambda cell: cell.str.strip_start())
        +--------+
        | a      |
        | ---    |
        | str    |
        ...
        >>> column.map(lambda cell: cell.str.strip_start(characters=" ~"))
        +------+
        | a    |
        | ---  |
        | str  |
    ...
    def to_date(self, *, format: str | None = "iso") -> Cell[date | None]:  # noqa: A002
        ...
        - By default, values are zero-padded, where applicable.
        ...
        >>> column.map(lambda cell: cell.str.to_date())
        +------------+
        | a          |
        | ---        |
        | date       |
        ...
        >>> column.map(lambda cell: cell.str.to_date(format="{D}.{M}.{Y}"))
        +------------+
        | a          |
        | ---        |
        | date       |
    ...
    def to_datetime(self, *, format: str | None = "iso") -> Cell[datetime | None]:  # noqa: A002
        ...
        >>> column1.map(lambda cell: cell.str.to_datetime())
        +-------------------------+
        | a                       |
        | ---                     |
        | datetime[μs, UTC]       |
    ...
    def to_float(self) -> Cell[float | None]:
        ...
        >>> column.map(lambda cell: cell.str.to_float())
        +---------+
        |       a |
        |     --- |
        |     f64 |
    ...
    def to_int(self, *, base: ConvertibleToIntCell = 10) -> Cell[int | None]:
        ...
        >>> column1.map(lambda cell: cell.str.to_int())
        +------+
        |    a |
        |  --- |
        |  i64 |
        ...
        >>> column2.map(lambda cell: cell.str.to_int(base=2))
        +------+
        |    a |
        |  --- |
        |  i64 |
    ...
    def to_lowercase(self) -> Cell[str | None]:
        ...
        >>> from portabellas import Column
        >>> column = Column("a", ["AB", "BC", None])
        >>> column.map(lambda cell: cell.str.to_lowercase())
        +------+
        | a    |
        | ---  |
        | str  |
    ...
    def to_time(self, *, format: str | None = "iso") -> Cell[time | None]:  # noqa: A002
        ...
        >>> column.map(lambda cell: cell.str.to_time())
        +--------------+
        | a            |
        | ---          |
        | time         |
        ...
        >>> column.map(lambda cell: cell.str.to_time(format="{h}:{m}"))
        +----------+
        | a        |
        | ---      |
        | time     |
